...
import { data } from '../Contacts/header'
const Header = () => {
    return (
        <div className='text-left flex flex-col gap-4'>
                <div className='text-2xl text-primayTitle font-semibold'>{data.name}</div>
                <div className='text-primary font-semibold'>{data.title}</div>
